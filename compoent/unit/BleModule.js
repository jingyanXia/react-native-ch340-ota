...
export default class BleModule{
    ...
    getUUID(peripheralInfo){       
        ...
        // this.writeWithResponseCharacteristicUUID = ['FFE1']
        // this.writeWithResponseServiceUUID = ['FFE0']
    }
	...
	write(data,index = 0) {
        ...
        // index=1
        console.log('进入写', this.writeWithResponseServiceUUID[index],this.writeWithResponseCharacteristicUUID[index],index);
        return new Promise( (resolve, reject) =>{
            BleManager.write(this.peripheralId, this.writeWithResponseServiceUUID[index], this.writeWithResponseCharacteristicUUID[index], data,24)
                .then(() => {
